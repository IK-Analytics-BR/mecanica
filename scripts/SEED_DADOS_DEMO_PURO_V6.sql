-- ============================================================
-- SEED_DADOS_DEMO_PURO_V6.sql
-- Correção: campos cpf E cnpj separados na tabela customers
-- ============================================================
...
-- ============================================================
-- 1. GARANTIR CATEGORIAS COM IDs ESPECÍFICOS
-- ============================================================
...
-- ============================================================
-- 2. GARANTIR MARCAS COM IDs ESPECÍFICOS
-- ============================================================
...
-- ============================================================
-- 3. FORNECEDORES (ID garantido via INSERT IGNORE + SELECT MAX)
-- ============================================================
...
-- ============================================================
-- 4. CLIENTES (15) - CORREÇÃO: cpf e cnpj separados
-- ============================================================
...
-- 5. VEÍCULOS (20)
-- ============================================================
INSERT INTO equipment (name, serial_number, model, year, fuel_type, accumulated_hours, customer_id, active, created_at) VALUES
('Honda Civic 2020', 'ABC1234', 'Civic', 2020, 'flex', 35000, 1, 1, NOW()),
('Toyota Corolla 2019', 'ABC1235', 'Corolla', 2019, 'flex', 42000, 2, 1, NOW()),
('VW Gol 2018', 'ABC1236', 'Gol', 2018, 'flex', 55000, 3, 1, NOW()),
('Chevrolet Onix 2021', 'ABC1237', 'Onix', 2021, 'flex', 28000, 4, 1, NOW()),
('Ford Ka 2017', 'ABC1238', 'Ka', 2017, 'flex', 62000, 5, 1, NOW()),
('Fiat Uno 2016', 'ABC1239', 'Uno', 2016, 'flex', 78000, 6, 1, NOW()),
('Hyundai HB20 2020', 'ABC1240', 'HB20', 2020, 'flex', 33000, 7, 1, NOW()),
('Renault Sandero 2019', 'ABC1241', 'Sandero', 2019, 'flex', 45000, 8, 1, NOW()),
('Jeep Compass 2021', 'ABC1242', 'Compass', 2021, 'flex', 25000, 9, 1, NOW()),
('Nissan Kicks 2020', 'ABC1243', 'Kicks', 2020, 'flex', 38000, 10, 1, NOW()),
('Peugeot 208 2019', 'ABC1244', '208', 2019, 'flex', 41000, 11, 1, NOW()),
('Citroën C3 2018', 'ABC1245', 'C3', 2018, 'flex', 52000, 12, 1, NOW()),
('Honda Fit 2017', 'ABC1246', 'Fit', 2017, 'flex', 58000, 13, 1, NOW()),
('Toyota Yaris 2020', 'ABC1247', 'Yaris', 2020, 'flex', 32000, 14, 1, NOW()),
('VW Polo 2021', 'ABC1248', 'Polo', 2021, 'flex', 22000, 15, 1, NOW()),
('Chevrolet Tracker 2020', 'ABC1249', 'Tracker', 2020, 'flex', 30000, 1, 1, NOW()),
('Ford EcoSport 2019', 'ABC1250', 'EcoSport', 2019, 'flex', 48000, 2, 1, NOW()),
('Fiat Strada 2021', 'ABC1251', 'Strada', 2021, 'flex', 20000, 3, 1, NOW()),
('Hyundai Creta 2020', 'ABC1252', 'Creta', 2020, 'flex', 36000, 4, 1, NOW()),
('Renault Duster 2018', 'ABC1253', 'Duster', 2018, 'flex', 65000, 5, 1, NOW())
...
-- ============================================================
-- 8. PRODUTOS (40 produtos - main_supplier_id agora existem)
-- ============================================================
...
('CBNFLTR001', 'P004', 'Filtro de Cabine - Wega', 'Filtros', 7, 6, 'UN', 40.00, 85.00, 18, 5, 4, 1, NOW(), '8421.23.40'),
('FRPD001', 'P005', 'Pastilha Freio Dianteira - Acdelco', 'Freios', 3, 5, 'UN', 80.00, 180.00, 25, 8, 5, 1, NOW(), '8708.30.10'),
('FRPT001', 'P006', 'Pastilha Freio Traseira - Valeo', 'Freios', 3, 8, 'UN', 70.00, 160.00, 20, 6, 5, 1, NOW(), '8708.30.20'),
('FRDS001', 'P007', 'Disco de Freio - Bosch', 'Freios', 3, 2, 'UN', 120.00, 280.00, 15, 5, 5, 1, NOW(), '8708.30.30'),
('OLEO5W001', 'P008', 'Óleo 5W30 - Castrol', 'Óleos', 8, 1, 'LT', 28.00, 60.00, 50, 15, 2, 1, NOW(), '2710.19.20'),
('OLEO10W001', 'P009', 'Óleo 10W40 - Shell', 'Óleos', 8, 1, 'LT', 26.00, 55.00, 45, 12, 2, 1, NOW(), '2710.19.30'),
('VELA001', 'P010', 'Vela de Ignição - NGK', 'Elétrica', 5, 4, 'PC', 22.00, 48.00, 30, 10, 3, 1, NOW(), '8511.10.00')
ON DUPLICATE KEY UPDATE sku = VALUES(sku);

INSERT INTO products (sku, internal_code, name, category, category_id, brand_id, unit_measure, cost_price, price, stock_quantity, min_stock, main_supplier_id, active, created_at, ncm) VALUES
('BATERIA60', 'P011', 'Bateria 60Ah - Moura', 'Elétrica', 5, 1, 'UN', 280.00, 450.00, 8, 3, 3, 1, NOW(), '8507.10.00'),
('CORREIA001', 'P012', 'Correia Dentada - Dayco', 'Motor', 1, 10, 'UN', 65.00, 140.00, 12, 4, 10, 1, NOW(), '4010.33.10'),
('TENSOR001', 'P013', 'Tensor Correia - Gates', 'Motor', 1, 11, 'UN', 85.00, 190.00, 10, 3, 10, 1, NOW(), '8708.99.10'),
('BOMBADAGUA', 'P014', 'Bomba D\'água - SKF', 'Arrefecimento', 6, 9, 'UN', 120.00, 280.00, 8, 3, 9, 1, NOW(), '8413.30.10'),
('AMORTDIANT', 'P015', 'Amortecedor Dianteiro - Monroe', 'Suspensão', 4, 1, 'PR', 180.00, 380.00, 12, 4, 8, 1, NOW(), '8708.80.10'),
('AMORTTRAS', 'P016', 'Amortecedor Traseiro - Cofap', 'Suspensão', 4, 1, 'PR', 150.00, 320.00, 10, 3, 8, 1, NOW(), '8708.80.20'),
('ROLAMENTO', 'P017', 'Rolamento de Roda - SKF', 'Transmissão', 2, 9, 'UN', 45.00, 95.00, 20, 6, 1, 1, NOW(), '8482.10.00'),
('COXIM001', 'P018', 'Coxim do Motor - Maxxi', 'Motor', 1, 7, 'UN', 65.00, 145.00, 15, 5, 1, 1, NOW(), '8708.99.20'),
('TERMINAL', 'P019', 'Terminal de Direção - TRW', 'Suspensão', 4, 1, 'PR', 55.00, 120.00, 18, 6, 8, 1, NOW(), '8708.94.10'),
('BIELETA', 'P020', 'Bieleta da Suspensão - Axios', 'Suspensão', 4, 1, 'PR', 35.00, 78.00, 22, 7, 8, 1, NOW(), '8708.99.30')
ON DUPLICATE KEY UPDATE sku = VALUES(sku);

INSERT INTO products (sku, internal_code, name, category, category_id, brand_id, unit_measure, cost_price, price, stock_quantity, min_stock, main_supplier_id, active, created_at, ncm) VALUES
('PIVO', 'P021', 'Pivô da Suspensão - Nakata', 'Suspensão', 4, 1, 'UN', 42.00, 95.00, 25, 8, 8, 1, NOW(), '8708.99.40'),
('PALHADIANT', 'P022', 'Palheta Dianteira - Bosch', 'Elétrica', 5, 2, 'PR', 35.00, 75.00, 30, 10, 6, 1, NOW(), '8512.10.00'),
('PALHATRAS', 'P023', 'Palheta Traseira - Valeo', 'Elétrica', 5, 8, 'UN', 25.00, 55.00, 20, 6, 6, 1, NOW(), '8512.10.10'),
('LAMPADA001', 'P024', 'Lâmpada Farol - Philips', 'Elétrica', 5, 1, 'UN', 18.00, 40.00, 40, 12, 3, 1, NOW(), '8539.21.00'),
('LAMPADA002', 'P025', 'Lâmpada Lanterna - Osram', 'Elétrica', 5, 1, 'UN', 12.00, 28.00, 35, 10, 3, 1, NOW(), '8539.29.00'),
('LIMPADOR', 'P026', 'Limpador de Para-brisa - Michelin', 'Acessórios', 10, 1, 'PR', 28.00, 65.00, 25, 8, 6, 1, NOW(), '8512.90.00'),
('ADITIVO001', 'P027', 'Aditivo Radiador - Prestone', 'Arrefecimento', 6, 1, 'LT', 18.00, 42.00, 30, 10, 9, 1, NOW(), '3820.00.10'),
('FLUIDOFREIO', 'P028', 'Fluido de Freio DOT4 - Bosch', 'Freios', 3, 2, 'LT', 15.00, 35.00, 35, 12, 5, 1, NOW(), '3819.00.10'),
('GRAXA001', 'P029', 'Graxa de Rolamento - Lubrax', 'Motor', 1, 1, 'LT', 22.00, 48.00, 20, 6, 1, 1, NOW(), '2710.19.40'),
('SILICONE', 'P030', 'Silicone de Junta - 3M', 'Motor', 1, 1, 'LT', 25.00, 58.00, 25, 8, 1, 1, NOW(), '3506.10.10')
ON DUPLICATE KEY UPDATE sku = VALUES(sku);

INSERT INTO products (sku, internal_code, name, category, category_id, brand_id, unit_measure, cost_price, price, stock_quantity, min_stock, main_supplier_id, active, created_at, ncm) VALUES
('JUNTAMOTOR', 'P031', 'Jogo de Juntas do Motor - Sabó', 'Motor', 1, 1, 'UN', 120.00, 280.00, 8, 3, 1, 1, NOW(), '8484.10.00'),
('RETENTOR', 'P032', 'Retentor de Motor - Corteco', 'Motor', 1, 1, 'UN', 18.00, 42.00, 30, 10, 1, 1, NOW(), '4016.93.00'),
('FILTROARREF', 'P033', 'Filtro do Ar Condicionado - Wega', 'Arrefecimento', 6, 6, 'UN', 32.00, 72.00, 22, 7, 4, 1, NOW(), '8421.23.50'),
('COMPRESAR', 'P034', 'Compressor do Ar - Denso', 'Arrefecimento', 6, 1, 'UN', 450.00, 950.00, 5, 2, 9, 1, NOW(), '8414.30.00'),
('CONDENSADOR', 'P035', 'Condensador do Ar - Valeo', 'Arrefecimento', 6, 8, 'UN', 280.00, 580.00, 6, 2, 9, 1, NOW(), '8418.99.00'),
('FILTROOLEO', 'P036', 'Refil Filtro Óleo - Mann', 'Filtros', 7, 1, 'UN', 18.00, 42.00, 40, 12, 4, 1, NOW(), '8421.23.60'),
('BOMBACOMB', 'P037', 'Bomba Combustível - Delphi', 'Motor', 1, 1, 'UN', 165.00, 350.00, 10, 3, 3, 1, NOW(), '8413.30.20'),
('SENSOROXIG', 'P038', 'Sonda Lambda - Bosch', 'Elétrica', 5, 2, 'UN', 185.00, 380.00, 8, 3, 3, 1, NOW(), '9032.89.00'),
('BOBINA', 'P039', 'Bobina de Ignição - NGK', 'Elétrica', 5, 4, 'UN', 95.00, 210.00, 12, 4, 3, 1, NOW(), '8511.20.00'),
('INJETOR', 'P040', 'Bico Injetor - Bosch', 'Motor', 1, 2, 'UN', 220.00, 480.00, 6, 2, 3, 1, NOW(), '8413.30.30')
ON DUPLICATE KEY UPDATE sku = VALUES(sku);
...
-- ============================================================
-- 22. LEITURAS DE QUILOMETRAGEM (10)
-- ============================================================
...
-- RESUMO
-- ============================================================
SELECT 'SEED V6 COMPLETO EXECUTADO!' AS RESULTADO;
SELECT CONCAT(
    'Dados criados: ',
