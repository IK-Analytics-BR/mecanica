-- ============================================================
-- SEED_DADOS_DEMO_PURO_V4.sql
-- Versão com ordem correta e verificação de dependências
-- ============================================================
...
-- ============================================================
-- Limpar e recriar com IDs específicos para garantir consistência
...
-- Continuar com mais produtos em lotes...
INSERT INTO products (sku, internal_code, name, category, category_id, brand_id, unit_measure, cost_price, price, stock_quantity, min_stock, main_supplier_id, active, created_at, ncm) VALUES
...
-- RESUMO
-- ============================================================
SELECT 'SEED V4 COMPLETO EXECUTADO!' AS RESULTADO;
SELECT CONCAT(
    'Dados criados: ',
