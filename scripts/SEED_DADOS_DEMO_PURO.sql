-- ============================================================
-- SEED_DADOS_DEMO_PURO.sql
-- Script SQL puro para popular dados fictícios de demonstração
-- NÃO requer Python/Flask - executa direto no MySQL
-- ============================================================
...
-- 4. FORNECEDORES
-- ============================================================
INSERT INTO suppliers (name, cnpj_cpf, email, phone, address, city, state, segment, credit_limit, active, created_at) VALUES
('AutoPeças Nacional Ltda', '12.345.678/0001-90', 'contato@autopecasnacional.com', '1130000001', 'Av. Industrial, 500', 'São Paulo', 'SP', 'fornecedor_pecas', 3000.00, 1, NOW()),
('Distribuidora de Óleos SP', '23.456.789/0001-01', 'vendas@oleossp.com', '1130000002', 'Rua do Óleo, 100', 'São Paulo', 'SP', 'fornecedor_oleo', 2500.00, 1, NOW()),
('Bosch Automotive Brasil', '34.567.890/0001-12', 'pedidos@bosch.com.br', '1130000003', 'Av. Bosch, 1000', 'São Paulo', 'SP', 'fornecedor_eletrica', 5000.00, 1, NOW()),
('Filtros & Cia', '45.678.901/0001-23', 'comercial@filtros.com', '1130000004', 'Rua dos Filtros, 200', 'São Paulo', 'SP', 'fornecedor_filtros', 1500.00, 1, NOW()),
('Freios Master', '56.789.012/0001-34', 'vendas@freiosmaster.com', '1130000005', 'Av. dos Freios, 300', 'São Paulo', 'SP', 'fornecedor_freios', 2000.00, 1, NOW()),
('Pneus Sul', '67.890.123/0001-45', 'contato@pneussul.com', '1130000006', 'Rua dos Pneus, 400', 'São Paulo', 'SP', 'fornecedor_pneus', 4000.00, 1, NOW()),
('Acessórios Automotivos', '78.901.234/0001-56', 'vendas@acessorios.com', '1130000007', 'Av. Acessórios, 150', 'São Paulo', 'SP', 'fornecedor_acessorios', 1000.00, 1, NOW()),
('Suspensão Pro', '89.012.345/0001-67', 'pedidos@suspensaopro.com', '1130000008', 'Rua da Suspensão, 250', 'São Paulo', 'SP', 'fornecedor_suspensao', 1800.00, 1, NOW()),
('Arrefecimento Plus', '90.123.456/0001-78', 'comercial@arrefecimento.com', '1130000009', 'Av. Arrefecimento, 350', 'São Paulo', 'SP', 'fornecedor_arrefecimento', 1200.00, 1, NOW()),
('Transmissão & Cia', '01.234.567/0001-89', 'vendas@transmissao.com', '1130000010', 'Rua da Transmissão, 450', 'São Paulo', 'SP', 'fornecedor_transmissao', 2200.00, 1, NOW())
ON DUPLICATE KEY UPDATE name = VALUES(name);
...
-- ============================================================
-- 12. ITENS DE SERVIÇO NAS OS (Adiciona valores)
-- ============================================================
...
(1, 'product', 1, 1, 55.00, 55.00, NULL),
...
(5, 'product', 5, 1, 180.00, 180.00, NULL),
...
('service', 20, 'Pagamento OS #20', 340.00, DATE_ADD(NOW(), INTERVAL 1 DAY), 'urgent', NOW()),
...
-- ============================================================
INSERT INTO accounts_payable (supplier_id, purchase_order_id, description, amount, due_date, status, created_at) VALUES
(1, NULL, 'Pagamento Fornecedor AutoPeças', 1500.00, DATE_ADD(NOW(), INTERVAL 10 DAY), 'pending', NOW()),
(2, NULL, 'Pagamento Distribuidora Óleos', 2000.00, DATE_ADD(NOW(), INTERVAL 5 DAY), 'pending', NOW()),
(3, NULL, 'Pagamento Bosch', 3500.00, DATE_ADD(NOW(), INTERVAL 15 DAY), 'pending', NOW()),
(4, NULL, 'Pagamento Filtros & Cia', 800.00, DATE_ADD(NOW(), INTERVAL 8 DAY), 'pending', NOW()),
(5, NULL, 'Pagamento Freios Master', 1200.00, DATE_ADD(NOW(), INTERVAL 12 DAY), 'pending', NOW()),
(1, NULL, 'Aluguel do mês', 2500.00, DATE_ADD(NOW(), INTERVAL 5 DAY), 'pending', NOW()),
(2, NULL, 'Energia Elétrica', 800.00, DATE_ADD(NOW(), INTERVAL 3 DAY), 'paid', NOW()),
(3, NULL, 'Internet/Telefone', 350.00, DATE_ADD(NOW(), INTERVAL 7 DAY), 'pending', NOW()),
(4, NULL, 'Salários', 8500.00, DATE_ADD(NOW(), INTERVAL 1 DAY), 'pending', NOW()),
(5, NULL, 'Impostos', 1200.00, DATE_ADD(NOW(), INTERVAL 20 DAY), 'pending', NOW());
...
(1, 1, DATE_SUB(NOW(), INTERVAL 5 DAY), 'pix', 'confirmed', 110.00, 0.00, 110.00, NOW()),
...
-- ============================================================
-- 16. KARDEX - Movimentações de estoque
-- ============================================================
...
-- ============================================================
-- 17. PLANO DE CONTAS (contabilidade)
-- ============================================================
...
-- RESUMO
-- ============================================================
SELECT 'SEED COMPLETO EXECUTADO!' AS RESULTADO;
SELECT CONCAT(
    'Dados criados: ',
