-- ============================================================
-- SEED_DADOS_DEMO_PURO_V5.sql
-- Versão com ordem correta: Fornecedores ANTES de Produtos
-- ============================================================
...
-- 4. CLIENTES (15)
-- ============================================================
INSERT INTO customers (name, email, phone, cpf, address, city, state, cep, active, created_at) VALUES
...
-- RESUMO
-- ============================================================
SELECT 'SEED V5 COMPLETO EXECUTADO!' AS RESULTADO;
SELECT CONCAT(
    'Dados criados: ',
